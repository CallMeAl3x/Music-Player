...
const App = () => {
  ...
  const handleAudioUpdate = () => {
    ...
    let musicCurrenTime = `${currentMin < 10 ? `0${currentMin}` : currentMin} : ${
  ...
  return (
    <div>
      <section className="card flex flex-col p-4 sm:justify-center sm:items-center min-h-screen">
        <audio
          id="audio"
        ...
        ></audio>
        <div className="bg-[#212936] rounded-xl max-sm:p-3 text-center max-sm:mt-[25%] max-w-sm p-4">
          <img src={currentMusicDetails.songAvatar} alt="" className="rounded-xl" />
          <h2 className="text-[#E5E7EB] mt-4 font-medium text-lg">{currentMusicDetails.songName}</h2>
